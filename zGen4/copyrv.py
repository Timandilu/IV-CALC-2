...
class RVForecaster:
    ...
    def prepare_features(self, df_prices: pd.DataFrame, df_iv: Optional[pd.DataFrame] = None) -> pd.DataFrame:
        ...
        print("Rv Columns:", rv_features.columns)
        df_iv = None
...
def main():
    ...
    if args.mode == 'train':
        ...
        if forecast_results:
            ...
            print(f"  Annualized RV: {forecast_results['rv_annualized']:.6f}")
        else:
...
Usage:
    python zGen4\\copyrv.py --mode train --data_path data/ --output_path results/
    python zGen4\\copyrv.py --mode predict --model_path models/ --data_path data/
    python zGen4\\copyrv.py --mode evaluate --data_path RVDATA/
"""